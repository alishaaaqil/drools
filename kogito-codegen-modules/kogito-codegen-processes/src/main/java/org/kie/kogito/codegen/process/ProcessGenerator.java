...
public class ProcessGenerator {
    ...
    /**
     * Transplants every method generated by {@link org.jbpm.compiler.canonical.ProcessVisitor} onto {@code cls},
     * not just the process entry point. The visitor is free to emit private helper methods alongside
     * {@value #PROCESS_METHOD_NAME} (e.g. to keep the generated bytecode of any single method under the JVM's
     * per-method size limit); dropping any of them here would silently produce an incomplete class.
     */
